"""Run the target-agnostic latent-disturbance reference benchmark."""
...
from interaction_sensing.simulation import LatentBenchmarkConfig, run_latent_benchmark, write_latent_benchmark
...
def main(argv: list[str] | None = None) -> int:
    ...
    outputs = write_latent_benchmark(args.output_dir, results, config, thresholds)
